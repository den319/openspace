...
import { useTakeSkip } from '@openspace/util/hooks/pagination'
import { useQuery } from '@apollo/client'
import {} from '@openspace/network/src/gql/generated'
...
export const ListGarages = ({
  ...
  return (
    <ShowData
      ...
      childrenClassName="grid mt-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-3"
      title={
