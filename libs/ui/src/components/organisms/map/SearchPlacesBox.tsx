import { LocationInfo, ViewState } from '@openspace/util/types'
import { useMap } from 'react-map-gl'
import { Autocomplete } from '../../atoms/Autocomplete'
import { useSearchLocation } from '@openspace/util/hooks/location'
import { majorCitiesLocationInfo } from '@openspace/util/constants'
