'use client'
import { BaseComponent, MenuItem, Role } from '@openspace/util/types'
...
import { useDialogState } from '@openspace/util/hooks/dialog'
  ...
  return (
    <header>
      <nav className="fixed z-40 top-0 w-full shadow-md bg-white/50 backdrop-blur-md">
        <Container className="relative flex items-center justify-between h-16 py-2 px-2 gap-16">
