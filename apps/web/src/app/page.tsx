'use client'
import { CarScene } from '@openspace/3d/src/scenes/CarScene'
...
export default function Home() {
  return (
    <main className="h-[calc(100vh-4rem)] ">
      ...
      <div className="flex flex-col items-start space-y-2 font-black text-5xl md:text-8xl">
        <div className="z-10 inline-block px-3 bg-primary mt-2">Need</div>{' '}
        <div className="z-10 inline-block md:w-full md:max-w-md px-3 bg-primary ">
          parking?
        </div>
        <Link
          href="/search"
