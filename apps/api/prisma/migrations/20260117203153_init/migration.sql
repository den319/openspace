...
-- CreateEnum
CREATE TYPE "LogCategory" AS ENUM ('SECURITY', 'API', 'AUTH', 'DATABASE', 'SYSTEM', 'USER_ACTIVITY');
...
-- CreateIndex
CREATE INDEX "ServerLog_category_idx" ON "ServerLog"("category");

-- CreateIndex
CREATE INDEX "ServerLog_userId_idx" ON "ServerLog"("userId");

-- CreateIndex
CREATE INDEX "ServerLog_ip_idx" ON "ServerLog"("ip");
